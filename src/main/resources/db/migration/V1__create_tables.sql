...
create table posts (id integer not null, is_active integer not null, moderation_status varchar(255) not null, text varchar(255) not null, time datetime not null, title varchar(255) not null, view_count integer not null, moderator_id integer not null, user_id integer not null, primary key (id));
...
create table users (id integer not null, code varchar(255), email varchar(255) not null, is_moderator integer not null, name varchar(255) not null, password varchar(255) not null, photo varchar(255), reg_time datetime not null, primary key (id));
